...
class MissingValueStrategy:
    ...
    ENHANCED: Always rounds age to integers, smarter mode calculation.
    """
    ...
    def generate_fixes(self, issue):
        ...
        # High missing percentage -> recommend dropping column
        if missing_pct > 40:
        ...
        # Numeric columns
            ...
            # Median for skewed data OR age columns
        ...
        # Categorical columns
            ...
            # Clean values: exclude special characters AND placeholder tokens
